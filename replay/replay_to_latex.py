...
# python replay_interactive_latex.py --log-dir experiment_v21 -v
...
# --- Configuration ---
DEFAULT_LOG_DIR = 'experiment_v21'
            ...
            if latex_mode:
                ...
                try:
                    current_latex_output = render_latex_frame(
                        ...
                        messages_by_round, round_num_int, generate_content_only=True
                    )
                except Exception as e:
